          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
            ...
            <div className="lg:w-1/2 flex flex-col h-full">
              ...
              <div className="bg-white rounded-3xl overflow-hidden h-80 lg:h-96 shadow-sm border border-gray-200 mb-8 relative group">
                ...
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3430.347572765366!2d76.7038!3d30.6758!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390fe8d61741d401%3A0x6097892336332145!2sOrane%20International%20Head%20Office!5e0!3m2!1sen!2sin!4v1625637289123!5m2!1sen!2sin" 
                  width="100%" 
                  height="100%" 
                  style={{border:0}} 
                  allowFullScreen="" 
                  loading="lazy"
                  title="Orane Head Office Map"
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-md p-4 rounded-xl shadow-lg flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-sm">Orane International Head Office</h4>
          ...
          <div className="bg-red-50 rounded-2xl p-6 md:p-10 border border-red-100 flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 text-sm font-bold">
                 <a href="mailto:grievance@orane.com" className="text-red-600 hover:underline">grievance@orane.com</a>
