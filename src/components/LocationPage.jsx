...
const centersData = [
  ...
  {
    id: 2,
    name: "PureRevive International Chandigarh",
    state: "Punjab",
    city: "Chandigarh",
    address: "SCO 14, Sector 34-A, Chandigarh",
    phone: "+91 98765 43210",
    email: "chandigarh@PureRevive.com",
  ...
  {
    id: 3,
    name: "PureRevive International Delhi (South)",
    state: "Delhi",
    city: "New Delhi",
    address: "A-12, Lajpat Nagar II, New Delhi",
    phone: "+91 11 2983 4567",
    email: "delhi.south@PureRevive.com",
  ...
  {
    id: 4,
    name: "PureRevive International Mumbai",
    state: "Maharashtra",
    city: "Mumbai",
    address: "201, Crystal Plaza, Andheri West, Mumbai",
    phone: "+91 22 4567 8900",
    email: "mumbai@PureRevive.com",
  ...
  {
    id: 5,
    name: "PureRevive International Vancouver",
    state: "British Columbia",
    city: "Vancouver",
    address: "123 W Hastings St, Vancouver, BC V6B 1H4, Canada",
    phone: "+1 604 123 4567",
    email: "vancouver@PureRevive.com",
    country: "Canada",
  ...
  {
    id: 6,
    name: "PureRevive International Bangalore",
    state: "Karnataka",
    city: "Bangalore",
    address: "100 Ft Road, Indiranagar, Bangalore",
    phone: "+91 80 1234 5678",
    email: "bangalore@PureRevive.com",
